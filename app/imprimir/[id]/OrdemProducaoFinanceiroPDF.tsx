...
const styles = StyleSheet.create({
  ...
  colIndex: { width: "8%", alignItems: "center", justifyContent: "center", paddingLeft: 4 },
...
const BlocoAprovacoesFinanceiras = () => {
  const campoAssinatura = { width: "30%", alignItems: "center" as const };
  ...
  return (
    ...
    >
      <Text style={{ fontSize: 10, color: "#2563eb", fontWeight: "bold", textTransform: "uppercase", marginBottom: 24 }}>
        Assinaturas / Aprovações Financeiras
      </Text>
      <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
        <View style={campoAssinatura}>
          <View style={styles.signatureLine} />
        ...
        <View style={campoAssinatura}>
          <View style={styles.signatureLine} />
          <Text style={styles.signatureText}>Diretoria</Text>
        </View>
        <View style={campoAssinatura}>
          <View style={styles.signatureLine} />
          <Text style={styles.signatureText}>Conferência Final</Text>
        </View>
      </View>
    </View>
  );
  ...
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        >
          <Text style={{ fontSize: 11, color: "#1f2937", fontWeight: "bold", textTransform: "uppercase" }}>
